...
df = pd.read_csv("/home/ubuntu/cur/program/Teaching/1/46鹿児島県_202507fit portal.csv")
...
plt.savefig("/home/ubuntu/cur/program/Teaching/1/発電出力_histogram(<=1000kW).png")
plt.clf() 
...
plt.savefig("/home/ubuntu/cur/program/Teaching/1/発電出力_histogram(<=1000kW)_solar.png")